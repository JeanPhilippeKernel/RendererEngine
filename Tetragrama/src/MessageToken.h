...
namespace Tetragrama
{
    ...
    static std::string_view EDITOR_COMPONENT_SCENEVIEWPORT_CLICKED               = "editor::component::sceneviewport::clicked";
    ...
    static std::string_view EDITOR_RENDER_LAYER_SCENE_REQUEST_SELECT_ENTITY_FROM_PIXEL = "editor::render_layer::scene::request::select_entity_from_pixel";
