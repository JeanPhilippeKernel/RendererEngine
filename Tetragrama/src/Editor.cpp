...
namespace Tetragrama
{
    ...
    void Editor::Initialize()
    {
        ...
        IMessenger::Register<ZEngine::Layers::Layer, Messengers::GenericMessage<bool>>(
            m_render_layer,
        ...
        IMessenger::Register<ZEngine::Layers::Layer, Messengers::EmptyMessage>(
            m_render_layer,
        ...
        IMessenger::Register<ZEngine::Layers::Layer, Messengers::GenericMessage<std::pair<int, int>>>(
            m_render_layer,
