...
namespace ZEngine::Core::Containers
{
    ...
    class UnorderedHashSetKeyIterator
    {
    public:
        using value_type        = K;
        ...
        explicit UnorderedHashSetKeyIterator(MapIt it) : m_it(it) {}

        // Advances the iterator to the next occupied entry.
        // @return Reference to the incremented iterator.
        UnorderedHashSetKeyIterator& operator++()
        {
            ++m_it;
            return *this;
        }
        ...
        bool operator!=(const UnorderedHashSetKeyIterator& other) const
        {
    ...
    {
    public:
        using MapType        = UnorderedHashMap<K, bool>;
        using size_type      = std::size_t;
        using iterator       = UnorderedHashSetKeyIterator<K, typename MapType::iterator>;
        using const_iterator = UnorderedHashSetKeyIterator<K, typename MapType::const_iterator>;
