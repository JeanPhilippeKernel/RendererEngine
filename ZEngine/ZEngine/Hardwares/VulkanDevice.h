...
namespace ZEngine::Hardwares
{
    ...
    struct VulkanDevice
    {
        ...
        Core::Containers::HashMap<uint32_t, VkDescriptorSetLayout>                                                          ShaderReservedDescriptorSetLayoutMap        = {}; // <set, layout>
        Core::Containers::HashMap<uint32_t, Core::Containers::Array<Rendering::Specifications::LayoutBindingSpecification>> ShaderReservedLayoutBindingSpecificationMap = {};
