...
namespace ZEngine::UI
{
    ...
    /// @returns ZUISize with the specified kind.
    ...
    /// @param all Padding in logical pixels applied to all four sides.
    ...
    /// @param box Target box.
    /// @param horiz Horizontal (left+right) padding in logical pixels.
    /// @param vert Vertical (top+bottom) padding in logical pixels.
    ...
    /// @brief Close the column opened by ZUIBeginColumn.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the row opened by ZUIBeginRow.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the scroll region opened by ZUIBeginScrollRegion.
    /// @param ctx Active ZUI context.
    ...
    /// @brief End the disabled scope opened by ZUIBeginDisabled.
    /// @param ctx Active ZUI context.
    ...
    /// @param ctx Active ZUI context.
    /// @param px Space size in logical pixels.
    ...
    /// @param ctx Active ZUI context.
    /// @param sig Signal from the widget to watch for hover.
    ...
    /// @param open Pointer to the open/close state (toggled on click).
    ...
    /// @param ctx Active ZUI context.
    /// @param key Widget key string.
    /// @param float_x Absolute X position.
    /// @param float_y Absolute Y position.
    ...
    /// @param ctx Active ZUI context.
    /// @param key Widget key string.
    /// @param label Tab label shown in the ghost.
    ...
    /// @brief Close the popup opened by ZUIBeginPopup.
    /// @param ctx Active ZUI context.
    ...
    /// @brief End the table opened by ZUIBeginTable.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the tab bar opened by ZUIBeginTabBar.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the context menu opened by ZUIBeginContextMenu.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the combo opened by ZUIBeginCombo.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the submenu opened by ZUIBeginSubMenu.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the tree view opened by ZUIBeginTreeView.
    /// @param ctx Active ZUI context.
    ...
    /// @brief Close the tree node opened by ZUITreeViewBeginNode.
    /// @param ctx Active ZUI context.
    ...
    {
        const char* Label     = nullptr; ///< Header label text (null-terminated).
        float       InitWidth = 0.f;     ///< Initial column width in px; 0 = 100 px default.
        float       MinWidth  = 0.f;     ///< Minimum resize floor; 0 = 30 px. Stretch columns use this to resist compression.
        bool        Sortable  = false;   ///< Show sort arrow on header click.
        bool        Resizable = false;   ///< Allow drag-resize on the column separator.
    };
    ...
    /// @param key Widget key string.
    /// @param col_count Number of columns.
    /// @param cols Array of ZUIDataTableColumn descriptors.
    ...
    /// @brief End the data table opened by ZUIBeginDataTable.
    /// @param ctx Active ZUI context.
    ...
    /// @param width_px Field width in logical pixels.
    ...
    /// @param ctx Active ZUI context.
    /// @param key Widget key string.
    /// @param buf Buffer holding the current text.
    ...
    /// @param ctx Active ZUI context.
    /// @param key Widget key string.
    /// @param value Pointer to the float value being resized.
    /// @param min_v Minimum allowed value.
    /// @param max_v Maximum allowed value.
    /// @param horizontal True for horizontal resize, false for vertical.
