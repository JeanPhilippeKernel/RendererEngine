...
namespace ZEngine::UI
{
    ...
    enum ZUIStyleVar : uint32_t
    {
        ...
        ZUIStyleVar_FramePaddingX,       ZUIStyleVar_FramePaddingY,
        ZUIStyleVar_ItemSpacingX,        ZUIStyleVar_ItemSpacingY,
        ZUIStyleVar_ItemInnerSpacingX,   ZUIStyleVar_ItemInnerSpacingY,
        ZUIStyleVar_FrameRounding,       ZUIStyleVar_PopupRounding,
        ZUIStyleVar_ScrollbarRounding,   ZUIStyleVar_GrabRounding,
        ZUIStyleVar_TabRounding,
        ZUIStyleVar_WindowBorderSize,    ZUIStyleVar_FrameBorderSize,
        ZUIStyleVar_PopupBorderSize,     ZUIStyleVar_TabBarBorderSize,
        ZUIStyleVar_TabBarOverlineSize,
        ZUIStyleVar_IndentSpacing,       ZUIStyleVar_ScrollbarSize,
        ZUIStyleVar_GrabMinSize,         ZUIStyleVar_DockingFocusBorderWidth,
        ZUIStyleVar_HoverAnimSpeed,      ZUIStyleVar_ActiveAnimSpeed,
        ZUIStyleVar_COUNT
    };
    ...
    struct ZUIContext
    {
        ...
        struct ZUIStyleEntry { ZUIStyleVar Id; float Old; };
    ...
    inline float ZUIGetFrameHeight(const ZUIContext* ctx) { return ctx->Style.FrameHeight; }
    inline float ZUIGetFramePadX  (const ZUIContext* ctx) { return ctx->Style.FramePadding[0]; }
    inline float ZUIGetFramePadY  (const ZUIContext* ctx) { return ctx->Style.FramePadding[1]; }
    inline float ZUIGetItemSpacX  (const ZUIContext* ctx) { return ctx->Style.ItemSpacing[0]; }
    inline float ZUIGetItemSpacY  (const ZUIContext* ctx) { return ctx->Style.ItemSpacing[1]; }
    inline float ZUIGetInnerSpac  (const ZUIContext* ctx) { return ctx->Style.ItemInnerSpacing[0]; }
