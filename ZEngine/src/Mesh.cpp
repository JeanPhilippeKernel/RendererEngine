...
namespace ZEngine::Rendering::Meshes {
    ...
    Mesh::Mesh() : m_unique_identifier(0), m_geometry(nullptr), m_material(nullptr) {}

    Mesh::Mesh(Geometries::IGeometry* const geometry, Materials::ShaderMaterial* const material) : m_unique_identifier(0), m_geometry(geometry), m_material(material) {}

    Mesh::Mesh(Ref<Geometries::IGeometry>&& geometry, Ref<Materials::ShaderMaterial>&& material)
        : m_unique_identifier(0), m_geometry(std::move(geometry)), m_material(std::move(material)) {}
