...
namespace ZEngine::Rendering::Renderers
{
    ...
    void ImGUIRenderer::Draw(uint32_t window_width, uint32_t window_height, const Ref<Swapchain>& swapchain, void* draw_data)
    {
    ...
    void ImGUIRenderer::Submit()
    {
        ...
        ZENGINE_VALIDATE_ASSERT(s_command_buffer != nullptr, "UI Command pool can't be null")
