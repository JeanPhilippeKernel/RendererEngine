...
//         static Mesh* CreateCube(const Maths::Vector2& position, const Maths::Vector3& size, float angle, const Maths::Vector3& axis, Rendering::Textures::Texture* const
//         texture); static Mesh* CreateCube(const Maths::Vector2& position, const Maths::Vector3& size, float angle, const Maths::Vector3& axis, Rendering::Textures::Texture2D*
//         const texture); static Mesh* CreateCube(
...
//         static Mesh* CreateCube(const Maths::Vector3& position, const Maths::Vector3& size, float angle, const Maths::Vector3& axis, Rendering::Textures::Texture* const
//         texture); static Mesh* CreateCube(const Maths::Vector3& position, const Maths::Vector3& size, float angle, const Maths::Vector3& axis, Rendering::Textures::Texture2D*
//         const texture); static Mesh* CreateCube(
