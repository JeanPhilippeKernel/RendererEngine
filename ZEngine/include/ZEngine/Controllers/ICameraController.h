...
namespace ZEngine::Controllers {
	...
	struct ICameraController : public IController {
		...
		ICameraController(const ZEngine::Ref<ZEngine::Window::CoreWindow>& window, bool can_rotate) 
			: 
		...
		ICameraController(const ZEngine::Ref<ZEngine::Window::CoreWindow>& window)
			:
			m_can_rotate(false),
			m_window(window)
		{
